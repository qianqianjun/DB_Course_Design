        ...
        <div class="col-md-6">
            <div class="index_rctx" id="area_one">
                <h5 class="index_title">
                    ...
                    <span class="more"><a href="#" class="right_more">更多</a></span>
                </h5>
                <c:if test="${!empty helpList}">
                <c:forEach items="${helpList}" var="elem">
                    <a class="list-group-item" href="${pageContext.request.contextPath}/messagedetail?id=${elem.getId()}" target="_blank">
            ...
            <div class="index_rctx" id="area_two">
                ...
                <c:if test="${!empty newcourse}">
                    <c:forEach items="${newcourse}" var="course">
                        <a class="list-group-item" href="${pageContext.request.contextPath}/coursedetail?id=${course.getId()}" target="_blank">
                        <span class="title_help">
                                ${course.getCname()}
                        </span>
                            <span class="sno_help">
